...
/// </summary>
/// <remarks>
/// <para>The library auto-registers a <c>NullAuthSource</c> via the
/// <c>AddAuthExtension()</c> entry point in <c>Zonit.Extensions.ServiceCollectionExtensions</c>;
/// a host that does <b>not</b> register its own implementation simply sees every
/// request as anonymous (no exceptions, no startup failure).</para>
///
